...
app = Flask("__name__")
df1 = pd.read_csv("first_telc.csv")
...
@app.route("/")
def home_page():
    return render_template("home_page_fin.html")
...
@app.route("/model")
def model():
    return render_template("model_page_fin.html")
...
def predict():
    ...
    print(model.predict_proba(new_df__dummies.tail(1)))

    if single == 1:
        o1 = "This customer is likely to be churned!!"
        o2 = "Confidence : "+str(int(probablity*100))+"%"
        return render_template('churn.html', o1=o1, o2=o2)
    else:
        o1 = "This customer is likely to continue!!"
        o2 = "Confidence : "+str(int(probablity*100))+"%"
        return render_template('non_churn.html', o1=o1, o2=o2)
